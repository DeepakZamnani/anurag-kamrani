  ...
  return (
    <Div article={props.article}>
      <LogoWrapper article={props.article}>
        {props.article && (
          <NameLink href="/">
            <NameArticle article={props.article}>Anurag Kamrani</NameArticle>
          </NameLink>
        )}
        {!props.article && <Name article={props.article}>Anurag Kamrani</Name>}
        {!props.article && <Role>Civil Engineer</Role>}
      </LogoWrapper>
      <div>
